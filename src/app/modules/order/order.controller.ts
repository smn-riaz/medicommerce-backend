...
const createOrderWithPrescription:RequestHandler = catchAsync(async(req,res) => {

    const orderInfo = req.body

    const result = await OrderServices.createOrderWithPrescriptionIntoDB(orderInfo)
...
const createOrderPaymentWithoutPrescription:RequestHandler = catchAsync(async(req,res) => {

    const orderInfo = req.body


    const result = await OrderServices.createOrderPaymentWithoutPrescriptionIntoDB(orderInfo)
...
const updatePrescriptionReview:RequestHandler = catchAsync(async(req,res) => {

    const {id} = req.params

    const result = await OrderServices.updatePrescriptionReviewIntoDB(id, req.body)
...
export const OrderController = {createOrderWithPrescription,updatePrescriptionReview, createOrderPaymentWithoutPrescription,getUserOrders,getSpecificOrder, getAllOrder, updateOrder}